...
def ParseArgs():
	...
	parser.add_argument('--social', default=True, type=float, help='Social Model')
	parser.add_argument('--item', default=True, type=float, help='Item Model')
	parser.add_argument('--leaky', default=0.5, type=float, help='slope of leaky relu')
	parser.add_argument('--tstBat', default=100, type=int, help='number of users in a testing batch')
